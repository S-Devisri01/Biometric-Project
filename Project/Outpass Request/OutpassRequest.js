...
const OutpassRequest = () => {
  ...
  const handleAction = (action) => {
    setSnackbar({
      open: true,
      message: `Outpass request ${action} successfully`,
  ...
  return (
    <Box>
      ...
      <Box className="Outpass-request-container" sx={{ margin: '20px auto', maxWidth: '900px' }}>
        <Card elevation={3}>
          <CardContent>
            ...
            <Box className="form-container">
              <Box className="form-content">
                ...
                <Box className="right-side">
                  ...
                  <Typography variant="body2" className="label">Outpass Type:</Typography>
                  <Typography variant="body1" className="value">Emergency Leave</Typography>
