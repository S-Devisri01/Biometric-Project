...
const LeaveRequest = () => {
  ...
  return (
    <Box>
      ...
      <Box className="leave-request-container" sx={{ margin: '20px auto', maxWidth: '900px' }}>
        <Card elevation={3}>
          <CardContent>
            ...
            <Box className="form-container">
              <Box className="form-content">
                ...
                <Box className="right-side">
                  ...
                  <Typography variant="body2" className="label">Leave Type:</Typography>
                  <Typography variant="body1" className="value">Sick Leave</Typography>
